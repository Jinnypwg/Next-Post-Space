        ...
        <div className="w-full max-w-lg p-6 bg-white rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="mt-5">
            <div className="mb-4">
              ...
              <input
                type="text"
                className={`w-full border-2 ${errors.title ? "border-red-500" : "border-primary"} focus:outline-none focus:border-blue-600 p-[6px] text-black px-4`}
                id="title"
            ...
            <div className="mb-4">
              ...
              <textarea
                className={`w-full border-2 ${errors.content ? "border-red-500" : "border-primary"} focus:outline-none focus:border-blue-600 p-[6px] text-black px-4`}
                id="body"
                value={formData.body}
                onChange={handleChange}
              />
            ...
            <div className="mb-4">
              ...
              <Select
                ...
                style={{ width: "100%" }}
                className={`w-full border-2 ${errors.tags ? "border-red-500" : "border-primary"} focus-visible:outline-none focus:outline-none focus:border-blue-600 p-[6px] text-black px-4`}
