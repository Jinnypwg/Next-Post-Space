    ...
    <>
      <form className="w-[400px]" onSubmit={handleRegister} noValidate>
        <div className="flex flex-col gap-6 mx-6">
          <div>
            ...
            <input
              ...
              required
              className={`w-full border-2 ${validationErrors.username ? "border-red-500" : "border-primary"} focus:outline-none focus:border-blue-600 rounded-full p-[6px] text-black px-4`}
            />
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full border-2 ${validationErrors.email ? "border-red-500" : "border-primary"} focus:outline-none focus:border-blue-600 rounded-full p-[6px] text-black px-4`}
            />
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full border-2 ${validationErrors.password ? "border-red-500" : "border-primary"} focus:outline-none focus:border-blue-600 rounded-full p-[6px] text-black px-4`}
            />
          ...
          <div>
            ...
            <select
              ...
              className="w-full border-2 border-primary focus:outline-none focus:border-blue-600 rounded-full p-[8px] text-black px-4 appearance-none">
        ...
        <div className="flex flex-col items-center mt-8 mx-6">
          <button
            type="submit"
            className={`${loading ? "bg-primary cursor-not-allowed" : "bg-primary hover:bg-blue-600"} text-black font-semibold px-6 py-2 rounded-full mb-4 w-full`}
            disabled={loading}>
